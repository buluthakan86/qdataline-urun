...
-- Bugun calistirilsaydi 7 onay dalindan 4'unu SESSIZCE SILERDI.
...
-- Bu modulun kendi onay mantigi artik su fonksiyondadir: public.urun_spec_onay_uygula()
-- =====================================================================
...
--
-- Tarihsel kayit olarak saklandi, calismasin diye YORUMA ALINDI.
-- Bu modulun kendi onay mantigi artik su fonksiyondadir: public.urun_spec_onay_onizle()
-- =====================================================================
